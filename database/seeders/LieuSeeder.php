    ...
    public function run()
    {
        DB::table('Lieux')->insert([
            ...
            [
                ...
                'noCivic' => 200,
                'codePostal' => 'G9A 6L5',
                'nomEtablissement' => 'Musée POP',
                'photoLieu' => 'Images/Lieux/pop.jpg',
                'siteWeb' => 'http://museepop.ca',
                'numeroTelephone' => '8193720406',
                'actif' => true,
                'description' => 'Musée d\'histoire populaire de Trois-Rivières',
                'quartierId' => 1,
                'typeLieuId' => 1,
                'proprietaireId' => 1,
                'created_at' => now(),
            ...
            [
                ...
                'noCivic' => 858,
                'codePostal' => 'G9A5J1',
                'nomEtablissement' => 'Musée Pierre-Boucher',
                'photoLieu' => 'Images/Lieux/ssj.jpg',
                'siteWeb' => 'http://museepierreboucher.ca',
                'numeroTelephone' => '8193764459',
                'actif' => true,
                'description' => 'Musée privé le plus ancien du Québec',
                'quartierId' => 1,
                'typeLieuId' => 2,
                'proprietaireId' => 1,
                'created_at' => now(),
            ...
            [
                ...
                'siteWeb' => 'http://borealis3r.ca',
                'numeroTelephone' => '8193724633',
                'actif' => true,
                'description' => 'Musée de l\'industrie papetière de Trois-Rivières',
                'quartierId' => 1,
                'typeLieuId' => 3,
                'proprietaireId' => 1,
                'created_at' => now(),
