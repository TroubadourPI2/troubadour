                ...
                <div class="flex w-full flex-col  gap-y-4 ">
                    <div class="flex flex-row justify-center gap-x-4">
                        <div
                            ...
                            <div class="flex  w-fit"><span class="iconify size-6 sm:size-8 "
                                    data-icon="ic:outline-place" data-inline="false"></span> </div>
                    ...
                    <div class="flex w-full justify-center md:px-1.5 ">
                        <div class="bg-c2 w-11/12 md:w-3/4 flex justify-center items-center    p-2 "> <span
                                class="text-c1  flex text-base min-[500px]:text-xl"> <span
                                    class="iconify size-8 text-c1 " data-icon="mdi-at"
                                    data-inline="false"></span>contact@troubadour.com</span></div>
                    </div>
                </div>
