<div>
    ...
    <form class="mt-2 text-c1 md:mx-10 xl:mx-20 2xl:mx-60" action="{{ route('usagerLieux.ajouterLieu') }}" method="POST"
        ...
        <div class="font-barlow text-c1 font-semibold mb-3">
            ...
            <div class="font-barlow text-c1 font-semibold uppercase mt-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-base sm:text-lg">
                    <div class="sm:col-span-1">
                        <label for="nomEtablissement" class="block">{{ __('nom') }} <span
            ...
            <div class="font-barlow text-c1 font-semibold uppercase mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-base sm:text-lg">
                    ...
                    <div class="sm:col-span-1">
                        <label for="rue" class="block">{{ __('rue') }} <span
                                class="text-c5 ml-2">*</span></label>
                    ...
                    <div class="sm:col-span-1">
                        <label for="codePostal" class="block">{{ __('codePostal') }} <span
                                class="text-c5 ml-2">*</span></label>
                    ...
                    <div class="sm:col-span-1">
                        <label for="selectQuartierLieu" class="block">{{ __('quartier') }}
