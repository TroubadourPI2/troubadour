...
<button id="boutonAjouterQuartier"
    class="rounded-full flex items-center justify-center uppercase text-lg leading-tight border-c1 border-2 text-c1 bg-c2 hover:bg-c3 pr-4 w-full sm:w-fit md:w-fit lg:w-fit px-4 py-2">
