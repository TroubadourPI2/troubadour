        ...
        <form class="lg:ml-1 lg:mr-0 mx-1 p-1 lg:pr-0 flex rounded-full justify-evenly flex-row w-full h-8 items-center" action="{{ route('lieux.recherche2') }}" method="post">
            ...
            <select
                ...
                @if (count($villes))
                    ...
                    @endforeach
                @else
                    <option value="default" disabled selected>{!! __('Aucune ville trouvé') !!}</option>
                @endif
            </select>
            ...
            <select
                ...
                @if(isset($quartiers))
                    ...
                    @endforeach
                @else
                    <option value="default" disabled selected hidden>{!! __('Choisir un quartier') !!}</option>
                @endif
            </select>
        ...
        <div class="flex flex-row items-center bg-c3 rounded-full justify-evenly mt-4 h-10 p-1.5">
            ...
            <select
                ...
                @if(isset($quartiers))
                    ...
                    @endforeach
                @else
                    <option value="default" disabled selected hidden id="optionDefaut">{!! __('Choisir un quartier') !!}</option>
                @endif
            </select>
        </div>
