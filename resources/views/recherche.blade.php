    ...
    <div class="lg:flex w-5/6 bg-c3 rounded-full justify-evenly items-center mt-4 h-10 hidden lg:h-12">
        <form class="lg:ml-1 lg:mr-0 mx-1 p-1 lg:pr-0 flex rounded-full justify-evenly flex-row w-full h-8 items-center" action="{{ route('lieux.recherche2') }}" method="post">
            ...
            <select
                ...
                <option value="default" disabled hidden <?php if ($ville == -1) { echo "selected"; } ?>>Choisir une ville</option>
                @if (count($villes))
                    ...
                    @endforeach
                @else
                    <option value="default" disabled selected>Aucune ville disponible</option>
                @endif
            </select>
            ...
            <select
                ...
                @if(isset($quartiers))
                    ...
                    @endforeach
                @else
                    <option value="default" disabled selected hidden>Choisir un quartier</option>
                @endif
            </select>
            ...
            <input type="text"
                ...
                placeholder="Rechercher un lieu" id="barreRecherche" name="txtRecherche" value="<?php if (isset($recherche)) { echo $recherche; } ?>">
    ...
    <form action="{{ route('lieux.recherche2') }}" class="flex lg:hidden flex-col w-full justify-start" method="POST">
        ...
        <div class="flex flex-row items-center bg-c3 rounded-full justify-evenly flex-column mt-4 h-10 p-1.5">
            <input type="text"
                ...
                placeholder="Rechercher un lieu" id="barreRecherche2" name="txtRecherche" value="<?php if (isset($recherche)) { echo $recherche; } ?>">
