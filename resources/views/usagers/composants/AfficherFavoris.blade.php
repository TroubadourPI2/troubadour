...
<div class="w-full mb-5">
    ...
    <div dir="ltr">
        ...
        <div class="overflow-x-auto snap-x">
            ...
            <div class="flex flex-nowrap space-x-4">
                @forelse ($usager->lieuFavoris as $favoriL)
    ...
    <div
        ...
        @forelse ($usager->activiteFavoris as $favoriA)
                    ...
                    <div class="opacity-90 bg-c1 flex w-full h-16 items-center">
                        ...
                        <div class="flex gap-x-2 px-4">
                            <button
                                ...
                                <span class="iconify size-6" data-icon="ion:trash-outline" data-inline="false"></span>
                            </button>
                        </div>
                    </div>
                </div>
