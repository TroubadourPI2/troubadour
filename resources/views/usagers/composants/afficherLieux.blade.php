                ...
                <div
                    ...
                    <div class="p-4 flex flex-col justify-between h-full">
                        ...
                        <div class="flex justify-end space-x-3 mt-3">
                            ...
                            <button class="modifierMobile" data-lieuId="{{$lieu->id}}" data-villeId="{{ $lieu->ville()?->id }}" data-typeLieuId="{{ $lieu->typeLieu->id }}"><span class="iconify text-ci size-6" data-icon="ep:edit"
                                    data-inline="false"></span></button>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full sm:w-1/2 p-4 flex flex-col h-full gap-y-[30px]">
                ...
                <div class="flex justify-end space-x-3 mt-auto">
                    <button><span class="iconify text-ci size-8" data-icon="ion:trash-outline"
                            data-inline="false"></span></button>
                    <button class="modifierWeb" data-lieuId="{{$lieu->id}}" data-villeId="{{ $lieu->ville()?->id }}" data-typeLieuId="{{ $lieu->typeLieu->id }}"><span class="iconify text-ci size-8" data-icon="ep:edit"
                            data-inline="false"></span></button>
                </div>
            </div>
        </div>
