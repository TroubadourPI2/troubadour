                    ...
                    <div class="w-full sm:w-1/2 p-4 flex flex-col h-full gap-y-4 relative">
                        @if (!$lieu->actif)
                            <div class="flex justify-end">
                                <span
                                    class="uppercase text-base text-c3 font-semibold px-2.5 py-0.5 rounded-full bg-c5 inline-block w-20 text-center">
                                    {{ __('inactif') }}
                                </span>
                            </div>
                        @else
                            <div class="flex justify-end">
                                <span
                                    class="uppercase text-base text-c3 font-semibold px-2.5 py-0.5 rounded-full bg-c1 inline-block w-20 text-center">
                                    {{ __('actif') }}
                                </span>
                            </div>
                        @endif
