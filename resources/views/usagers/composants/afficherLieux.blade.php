    ...
    @else
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            @foreach ($lieuxUsager as $lieu)
                ...
                <div
                    class="carteWeb flex flex-col sm:flex-row text-c1 rounded-lg shadow-md bg-white w-full max-w-4xl mx-auto my-4 hidden sm:flex h-[70vh] hover:shadow-2xl transition">
