    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
        ...
        <div class="sm:hidden flex flex-row flex-wrap gap-4 items-center text-c1 rounded-lg">
            <div
                ...
                <div class="absolute bg-c3 inset-0 rounded-lg shadow-lg flex flex-col items-center [backface-visibility:hidden]">
                    <img class="object-cover w-full h-72 md:h-auto md:w-48 rounded-t-lg"
                        src="{{ asset($lieu->photoLieu) }}" alt="{{ $lieu->nomEtablissement }}">
                    <h5 class="mb-2 text-xl font-semibold uppercase p-2  flex items-center h-full">{{ $lieu->nomEtablissement }}</h5>
                </div>
                <div
                    ...
                    <div class="p-4 flex flex-col justify-between h-full">
                        ...
                        <div class="flex justify-end space-x-3 mt-3">
                            ...
                            <button class="modifierMobile" data-id="{{ $lieu->id }}"><span class="iconify text-ci size-6" data-icon="ep:edit"
                                    data-inline="false"></span></button>
                        </div>
                    </div>
                </div>
