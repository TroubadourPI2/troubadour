<div>
    ...
    <form id="formModifierLieu" class="mt-2 text-c1" action="{{ route('usagerLieux.modifierLieu', [$lieu->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="font-barlow text-c1 font-semibold mb-3">
            ...
            <div class="font-barlow text-c1 font-semibold uppercase mt-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-base sm:text-lg">
                    <div class="sm:col-span-1">
                        <label for="nomEtablissementModifie" class="block">Nom <span class="text-c5 ml-2">*</span></label>
            ...
            <div class="font-barlow text-c1 font-semibold uppercase mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-base sm:text-lg">
                    ...
                    <div class="sm:col-span-1">
                        <label for="codePostalModifie" class="block">Code postal <span class="text-c5 ml-2">*</span></label>
