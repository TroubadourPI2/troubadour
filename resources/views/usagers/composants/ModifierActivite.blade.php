...
<div>
    ...
    <form class="mt-2 text-c1" action="{{ isset($activiteChoisit) ? route('usagerActivites.modifierActivite', $activiteChoisit->id) : '#' }}" method="POST"
        ...
        <div class="font-barlow text-c1 font-semibold mb-3">
            ...
            <div class="font-barlow text-c1 font-semibold uppercase mt-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-base sm:text-lg">
                    ...
                    <!-- Ajout des images -->
                    <div class="sm:col-span-1">
                        <label for="photosModif" class="block">Photos de l'activité (max 2mo par image)</label>
            ...
            <input type="hidden" name="photos_a_supprimer" id="photos_a_supprimer">
