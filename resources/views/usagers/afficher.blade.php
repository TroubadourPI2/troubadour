    ...
    <div class="flex flex-col w-full h-full ">
        <div
            ...
            <button id="boutonCompte" data-section="compte"
                class="BoutonMenuCompte text-base px-4 sm:text-2xl font-semibold sm:hover:bg-c1 sm:hover:text-c3 rounded-full sm:w-32 mb-1 uppercase">Compte</button>
            <div class="sm:h-6 h-4 sm:border-l-[3px] border-l-2 border-c1"></div>
            <button id="boutonLieu" data-section="lieux"
                class="BoutonMenuCompte text-base px-4 sm:text-2xl font-semibold sm:hover:bg-c1 sm:hover:text-c3 rounded-full sm:w-32 mb-1 uppercase">Lieux</button>
            <div class="sm:h-6 h-4 sm:border-l-[3px] border-l-2 border-c1"></div>
            <button id="boutonActivites" data-section="activites"
                class="BoutonMenuCompte text-base px-4 sm:text-2xl font-semibold sm:hover:bg-c1 sm:hover:text-c3 rounded-full sm:w-32 mb-1 uppercase">Activités</button>
        </div>
