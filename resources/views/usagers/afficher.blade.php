...
<div class="flex flex-col w-full h-full ">
    <div class="flex items-center sm:justify-start text-c1 justify-center md:space-x-2 space-x-4 sm:border-b-[3px] border-b-2 border-c1 sm:h-10 h-6 w-full my-3">
        <button id="boutonCompte" data-section="compte" class="BoutonMenuCompte text-base px-4 sm:text-2xl font-semibold bg-c1 text-c3 rounded-full sm:w-32 mb-1 uppercase transition">Compte</button>
