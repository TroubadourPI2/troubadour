...
@section('contenu')
    ...
    <div class="flex flex-col w-full h-full ">
        <div class="flex items-center md:justify-start text-c1 justify-center md:space-x-2 space-x-4 md:border-b-[3px] border-b-2 border-c1 md:h-10 h-6 w-full hover:">
