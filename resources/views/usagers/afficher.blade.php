    ...
    <div class="flex flex-col w-full h-full ">
        ...
        <div
            ...
            <button id="boutonCompte" data-section="compte"
                class="boutonMenuCompte text-base px-4 sm:text-2xl font-semibold bg-c1 text-c3 rounded-full sm:w-32 mb-1 uppercase transition">{{ __('compte') }}</button>
            @role(['Gestionnaire'])
                <div class="sm:h-6 h-4 sm:border-l-[3px] border-l-2 border-c1"></div>
                <button id="boutonLieu" data-section="lieux"
                    class="boutonMenuCompte text-base px-4 sm:text-2xl font-semibold sm:hover:bg-c1 sm:hover:text-c3 rounded-full sm:w-32 mb-1 uppercase transition">{{ __('lieux') }}</button>
                <div class="sm:h-6 h-4 sm:border-l-[3px] border-l-2 border-c1"></div>
                <button id="boutonActivites" data-section="activites"
                    class="boutonMenuCompte text-base px-4 sm:text-2xl font-semibold sm:hover:bg-c1 sm:hover:text-c3 rounded-full sm:w-32 mb-1 uppercase transition">{{ __('activites') }}</button>
            @endrole
        </div>
